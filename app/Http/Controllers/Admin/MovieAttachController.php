...
class MovieAttachController extends Controller
{
    ...
    {
        return Inertia::render('Admin/Movie/Attach', [
            'movie' => $movie,
    ...
    public function addTrailer(Movie $movie)
    {
        ...
        return Redirect::back()->banner('Trailer Added.');
    }
    ...
    public function addDownload(Movie $movie)
    {
        ...
        return Redirect::back()->banner('Download Added.');
    }

    public function destroyTrailer(TrailerUrl $trailerUrl)
    {
        $trailerUrl->delete();
        return Redirect::back()->banner('Trailer deleted.');
    }

    public function destroyDownload(Download $download)
    {
        $download->delete();
        return Redirect::back()->banner('Download deleted.');
    }
    ...
    public function addCast(Movie $movie)
    {
        ...
        return Redirect::back()->banner('Casts attached.');
    }
    public function addTag(Movie $movie)
    {
        ...
        return Redirect::back()->banner('Tags attached.');
    }
}
