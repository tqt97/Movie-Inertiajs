<div class="w-full text-gray-700 bg-white dark:text-gray-100 dark:bg-gray-900">
    <div x-data="{ open: false }"
        ...
        <nav :class="{'flex': open, 'hidden': !open}"
            ...
            <a class="{{ request()->routeIs('movies.*') ? 'bg-gray-200 dark:bg-gray-700' : 'bg-transparent' }} px-4 py-2 mt-2 text-sm font-semibold rounded-lg dark:hover:bg-gray-600 dark:focus:bg-gray-600 dark:focus:text-white dark:hover:text-white dark:text-gray-200 md:mt-0 md:ml-4 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline"
                href="{{ route('movies.index') }}">
                Movies
            </a>
            <a class="{{ request()->routeIs('series.*') ? 'bg-gray-200 dark:bg-gray-700' : 'bg-transparent' }} px-4 py-2 mt-2 text-sm font-semibold rounded-lg dark:hover:bg-gray-600 dark:focus:bg-gray-600 dark:focus:text-white dark:hover:text-white dark:text-gray-200 md:mt-0 md:ml-4 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline"
                href="{{ route('series.index') }}">
                Series
            </a>
            <a class="{{ request()->routeIs('casts.*') ? 'bg-gray-200 dark:bg-gray-700' : 'bg-transparent' }} px-4 py-2 mt-2 text-sm font-semibold rounded-lg dark:hover:bg-gray-600 dark:focus:bg-gray-600 dark:focus:text-white dark:hover:text-white dark:text-gray-200 md:mt-0 md:ml-4 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline"
                href="{{ route('casts.index') }}">
                Casts
            </a>
            <div @click.away="open = false" class="relative" x-data="{ open: false }">
                <button @click="open = !open"
                    class="{{ request()->routeIs('genres.*') ? 'bg-gray-200 dark:bg-gray-700' : 'bg-transparent' }} flex flex-row items-center w-full px-4 py-2 mt-2 text-sm font-semibold text-left  rounded-lg  dark:focus:text-white dark:hover:text-white dark:focus:bg-gray-600 dark:hover:bg-gray-600 md:w-auto md:inline md:mt-0 md:ml-4 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline">
                    <span>Genres</span>
